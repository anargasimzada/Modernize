...
import icoPan from './~/admin/ico-pan-hand.svg'
import icoZoom from './~/admin/ico-zoom-in.svg'
import icoReset from './~/admin/ico-home.svg'
import icoZoomIn from './~/admin/ico-plus.svg'
import icoZoomOut from './~/admin/ico-minus.svg'
import icoSelect from './~/admin/ico-select.svg'
import icoMenu from './~/admin/ico-menu.svg'
